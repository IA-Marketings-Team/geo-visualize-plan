  ...
  return (
    <PageLayout>
      <PageHeader 
        ...
        subtitle="Informations juridiques concernant le site Geo-architectural"
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4 md:px-6">
          <AnimatedSection className="prose prose-lg max-w-4xl mx-auto">
            ...
            <p>
              Le présent site, accessible à l'URL www.geo-architectural.fr (le « Site »), est édité par :
            </p>
            <p>
              Geo-architectural, société au capital de 100 000 euros, inscrite au R.C.S. de PARIS sous le numéro RCS PARIS 123 456 789, dont le siège social est situé au 123 Avenue de la Cartographie, 75001 Paris, France
            </p>
            <p>
              Le numéro de téléphone du directeur de la publication est le +33 1 23 45 67 89, et son adresse e-mail est contact@geo-architectural.fr.
            </p>
            ...
            <p>
              ...
              Par email : contact@geo-architectural.fr<br />
            ...
            <p>
              Le contenu du présent site, incluant, de façon non limitative, les graphismes, images, textes, vidéos, animations, sons, logos, gifs et icônes ainsi que leur mise en forme sont la propriété exclusive de la société geo-architectural à l'exception des marques, logos ou contenus appartenant à d'autres sociétés partenaires ou auteurs.
            </p>
            <p>
              Toute reproduction, distribution, modification, adaptation, retransmission ou publication, même partielle, de ces différents éléments est strictement interdite sans l'accord exprès par écrit de geo-architectural.
            </p>
          </AnimatedSection>
        </div>
      </section>
